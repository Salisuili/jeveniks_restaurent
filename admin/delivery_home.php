...
<div class="navbar">
    <div class="brand">Jeveniks Restaurant</div>
    <div class="menu-container">

        <a href="dellogout.php" class="menu logout">Logout</a>
    </div>
</div>
<style>
...
<div class="content">
    ...
    <table class="styled-table">
        ...
        <tr>
            ...
            <td><a href="delivered.php?a=<?php echo $r['id']; ?>" class="del">Delivered and Paid</a></td>
        </tr>
        <?php
        }
        ?>
