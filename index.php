		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Jeveniks Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">Jeveniks Restaurant is serving a Authentic Nigeian Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood with Jeveniks</strong></h1>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Jeveniks Restaurant</span></h1>
						<h4>Little Story</h4>
						<p>Restaurants in Kaduna, Kadunna Restaurants, Zaria restaurants, Rigasa restaurants, Kano restaurants, Momo Restaurants in Kaduna, 
 </p>
						<p>Quick Bites in Jeveniks, Quick Bites near me, Quick Bites in West Jeveniks, Quick Bites in Zaria, in Kaduna, near me, in South Kaduna, Christmas' Special in Kaduna,</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Jeveniks Restaurent</span>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 special-grid drinks">
									<div class="gallery-single fix">
										<img src="admin/<?php echo $r['image']; ?>" class="img-fluid" alt="Image" style='width: 263px; height:240px;'>
										<div class="why-text">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for Jeveniks Restaurent Listed Here </p>
					</div>
				</div>
			</div>
	...
	<div class="customer-reviews-box" style="width:100%;"> 
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Usman</strong></h5>
